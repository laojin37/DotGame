...
@synthesize isPluginedHeadphoneJack;
...
//	[director_ setDisplayStats:YES];
    ...
    self.isPluginedHeadphoneJack = [self isAudioJackPlugged];
...
void audioRouteChangeListenerCallback (void *inUserData, AudioSessionPropertyID inPropertyID, UInt32 inPropertyValueSize, const void *inPropertyValue ) {
    ...
    {
        AppController* delegate = (AppController*)inUserData;
        ...
        if (routeChangeReason == kAudioSessionRouteChangeReason_OldDeviceUnavailable) {
            delegate.isPluginedHeadphoneJack = NO;
            //Handle Headset Unplugged
        } else if (routeChangeReason == kAudioSessionRouteChangeReason_NewDeviceAvailable) {
            //Handle Headset plugged in
            delegate.isPluginedHeadphoneJack = YES;
        }
