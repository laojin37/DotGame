...
static int _max = 199; // bar.png Image Width
...
{
    _max = 199*(IS_IPAD()?2:1);

	[super initFromNormalImage:@"slider_btn.png" 
				 selectedImage:@"slider_btn.png" 
...
-(id) initWithTarget:(id)t selector:(SEL)sel
{
	if( (self = [super init]) ) {
		...
		if( _touchLogic ) {
			...
			barImage_ = [CCSprite spriteWithFile:@"slider_btn.png"];
